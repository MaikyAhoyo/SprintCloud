...
public class LibroController {
	...
	public Libro MetodoAlternativo(Long id) {
		Libro libro = new Libro();
		Date date = new Date();
		
		libro.setTitulo("Papu pro");
		libro.setAutor("Alvarito");
		libro.setGenero("Papuficcion");
		libro.setIdioma("Papuidioma");
		libro.setEditorial("Papueditorial");
		libro.setISBN(1323313);
		libro.setCreateAt(date);
		libro.setPublicationDate(date);
		return libro;
	}
